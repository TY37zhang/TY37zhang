<h2> Hi, I'm Tianyin Ty Zhang! <img src="https://media.giphy.com/media/mGcNjsfWAjY5AEZNw6/giphy.gif" width="50"></h2>
...
<p><em>
  Master's Student at <a href="https://tech.cornell.edu/">Cornell Tech</a>
...
let Ty = {
  pronouns: "He" | "Him",
  code: ["Typescript", "Javascript", "HTML", "CSS", "Python", "SQL"],
  tools: ["React", "Next", "Node", "Tailwind", "Styled-Components", "Figma"],
  skills: [
